  ...
  return (
    <section className="bg-white py-12 px-4 sm:px-6 md:px-20">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl sm:text-4xl font-bold text-[#1c2b4a] mb-6">
          About Us
        </h2>
      ...
      <div className="py-10 px-4 sm:px-6 md:px-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <div className="bg-white rounded-2xl shadow-lg p-5 sm:p-6 hover:shadow-xl transition">
            <h2 className="text-xl sm:text-2xl font-bold text-[#1c2b4a] mb-4 flex items-center gap-2">
              <img className="h-[28px] sm:h-[30px]" src="./images/location.svg" alt="Location Icon" />
              Address
            </h2>
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              <span className="font-semibold">Vivekanand Sr Sec School Pindwara</span>,<br />
              Near Power House, Rj Sh 62, Swami Vivekanand Colony,<br />
              Forest Colony, Pindwara-307022
            </p>
          </div>

          <div className="bg-white rounded-2xl shadow-lg p-5 sm:p-6 hover:shadow-xl transition">
            <h2 className="text-xl sm:text-2xl font-bold text-[#1c2b4a] mb-4 flex items-center gap-2">
              <img className="h-[22px] sm:h-[24px]" src="./images/contact.svg" alt="Contact Icon" />
              Contact
            </h2>
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
