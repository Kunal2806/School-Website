            ...
            <ul className="md:flex hoverNav w-full hidden p-5 itmes-center gap-5 md:gap-15 font-Lato justify-center font-bold text-md text-white mt-2 bg-[#1c2b4a] py-2 ">
                ...
                <li><span className="flex flex-cols" onClick={()=>{activeNavDrop("projectDescription")}}> Project Description 
                    ...
                    </span> 
                    {
                        ...
                        <li> <Link to="/project/education">Education</Link></li>
                        <li> <Link to="/project/livelihood">Livelihood Program</Link></li>
                        <li><Link to="/project/environment">Environment</Link></li>
                        <li> <Link to="/project/womenempowerment">Woman Empowerment</Link></li>
                        <li> <Link to="/project/tribalregion">Working In Tribal Region</Link></li>
                        <li> <Link to="/project/medical">Medical</Link></li>
                    </ul>
                    }
                </li>
